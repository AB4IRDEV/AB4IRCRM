<div x-data="{ open: false }">
    <!-- Edit Button -->
    <button @click="open = true" class="px-3 py-1 bg-yellow-500 hover:bg-red-700
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-1/3">
            ...
            <form method="POST" action="{{ url('permissions/'. $permission->id) }}">
                ...
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" value="{{ $permission->name }}" required autofocus />
